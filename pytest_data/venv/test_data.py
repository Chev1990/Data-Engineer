...
def connectdb():
    ...
    conndb = pyodbc.connect('DRIVER={ODBC Driver 18 for SQL Server};UID=TestDQA;PWD=Password12345;Database=TRN;Server=XPESMALW0018\LOCALDB#25DBD486;Trusted_Connection=yes;')
