...
def connectdb():
    ...
    conndb = pyodbc.connect('DRIVER={ODBC Driver 18 for SQL Server};UID=TestDQA;PWD=Password12345;Database=TRN;Trusted_Connection=yes;Server=XPESMALW0018\(localdb)\MyInstance;')
