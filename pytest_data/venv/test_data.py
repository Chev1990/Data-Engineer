...
def connectdb():
    ...
    conndb = pyodbc.connect('DRIVER={ODBC Driver 17 for SQL Server};User=TestDQA;Password=Password12345;Database=TRN;Trusted_Connection=yes;Server=XPESMALW0018\(localdb)\\MyInstance;')
